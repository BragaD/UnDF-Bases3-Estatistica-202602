...
::: {.callout-note}
Este capítulo é baseado no Capítulo 1 de @bruce2020, com os quantis empíricos das seções 1.4 e 1.5 vindos da seção 3.3 de @bussab2023.
:::

📓 [**Abrir o notebook deste capítulo no Colab ↗**](https://colab.research.google.com/github/BragaD/UnDF-Bases3-Estatistica-202602/blob/main/notebooks/capitulo-01.ipynb) — só o código, pronto para rodar.
...
- Explorar a distribuição de uma variável com percentis, boxplots, histogramas e assimetria
- Tratar dados binários e categóricos
- Medir e visualizar a correlação entre variáveis, e reconhecer suas armadilhas
- Explorar relações entre duas ou mais variáveis, numéricas e categóricas *(leitura complementar)*
...
| [1.8](08-duas-ou-mais-variaveis.qmd) | Explorando Duas ou Mais Variáveis *(leitura complementar — fora do cronograma)* |
