...
- Usar **testes de permutação** (reamostragem) para avaliar significância sem supor normalidade
- Interpretar corretamente um valor-p — e reconhecer as interpretações erradas mais comuns
- Aplicar **testes t** para comparar médias, sabendo quando cada variante cabe
