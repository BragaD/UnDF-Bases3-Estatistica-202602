...
|---|---|---|
| Carrier | `{python} num(dfw['Carrier'].iloc[0], 0)` | `{python} f"{proporcoes['Carrier'].iloc[0]:.2f}"`% |
| ATC | `{python} num(dfw['ATC'].iloc[0], 0)` | `{python} f"{proporcoes['ATC'].iloc[0]:.2f}"`% |
| Weather | `{python} num(dfw['Weather'].iloc[0], 0)` | `{python} f"{proporcoes['Weather'].iloc[0]:.2f}"`% |
| Security | `{python} num(dfw['Security'].iloc[0], 0)` | `{python} f"{proporcoes['Security'].iloc[0]:.2f}"`% |
| Inbound | `{python} num(dfw['Inbound'].iloc[0], 0)` | `{python} f"{proporcoes['Inbound'].iloc[0]:.2f}"`% |
