...
|---|---|---|
| Carrier | `{python} f"{dfw['Carrier'].iloc[0]:,.0f}"` | `{python} f"{proporcoes['Carrier'].iloc[0]:.2f}"`% |
| ATC | `{python} f"{dfw['ATC'].iloc[0]:,.0f}"` | `{python} f"{proporcoes['ATC'].iloc[0]:.2f}"`% |
| Weather | `{python} f"{dfw['Weather'].iloc[0]:,.0f}"` | `{python} f"{proporcoes['Weather'].iloc[0]:.2f}"`% |
| Security | `{python} f"{dfw['Security'].iloc[0]:,.0f}"` | `{python} f"{proporcoes['Security'].iloc[0]:.2f}"`% |
| Inbound | `{python} f"{dfw['Inbound'].iloc[0]:,.0f}"` | `{python} f"{proporcoes['Inbound'].iloc[0]:.2f}"`% |
