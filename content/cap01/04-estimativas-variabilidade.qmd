...
Essa padronização — subtrair a média, dividir pelo desvio-padrão — não é exclusiva deste exemplo: é a mesma conta que a distribuição Normal usa como referência (Cap. 2, seção 2.5), e é a mesma conta que o widget logo abaixo já emprega para mudar a dispersão da taxa de homicídios sem tocar na média.
