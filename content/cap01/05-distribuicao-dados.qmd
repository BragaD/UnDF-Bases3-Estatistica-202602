...
Fica a antecipação: o Capítulo 2 (seção 2.6) volta à curtose para caracterizar caudas longas de forma mais completa — lá ela deixa de ser só um número solto e vira parte do diagnóstico de quando a normal deixa de ser um modelo razoável para os dados.
