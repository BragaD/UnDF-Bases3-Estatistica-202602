...
// numérica — um format que devolvesse "37,3 M" deixaria a caixa VAZIA. Sem ele,
...
// exatamente 37.253.956 — a população real da Califórnia. Em milhões, o
...
viewof pop_ca = Inputs.range([1_000_000, 300_000_000], {
  step: 1,
  value: 37253956,
  label: "População da Califórnia (habitantes):"
})
```

```{ojs}
//| echo: false
md`Califórnia: **${fmt(pop_ca)}** habitantes — ${fmt(pop_ca / 1e6)} milhões.
${pop_ca === 37253956 ? "É o valor real." : "O valor real é 37.253.956."}`
```
